...
export const LivestockIntegrationFlow: React.FC<LivestockIntegrationFlowProps> = ({
  ...
  const nodes = [
    {
      ...
      color: '#C69B3A',
      type: 'input',
      detail: 'Bush clearance generates R1.08-3M wood revenue while feeding goats',
    },
    {
      id: 'goats',
      name: 'Goats',
      ...
      color: '#8B7355',
      type: 'livestock',
      detail: 'Browse sekelbos reducing 60-80% canopy, producing meat & dairy',
    },
    {
      id: 'manure1',
      name: 'Goat Manure',
      ...
      color: '#6B5D4F',
      type: 'byproduct',
      detail: 'High-nitrogen organic fertilizer for crops',
    },
    {
      id: 'crops',
      name: 'Crops',
      subtitle: '180ha dryland',
      x: 300,
      y: 400,
      color: '#5DAA68',
      type: 'crop',
      detail: 'Maize, sorghum, sunflower rotation providing feed grain',
    },
    {
      id: 'lucerne',
      name: 'Lucerne',
      subtitle: '2-5ha irrigated',
      x: 600,
      y: 300,
      color: '#4C9F70',
      type: 'crop',
      detail: 'Protein-rich feed fixing 150-200kg N/ha/year',
    },
    {
      id: 'feed',
      name: 'Feed Mix',
      ...
      color: '#8B6F47',
      type: 'process',
      detail: 'Balanced rations optimized for each species',
    },
    {
      id: 'cattle',
      name: 'Cattle',
      ...
      color: '#8B4513',
      type: 'livestock',
      detail: 'Nguni×Brahman×Bosmara generating R432-584K/year',
    },
    {
      id: 'pigs',
      name: 'Pigs',
      subtitle: '250 finishers',
      x: 450,
      y: 520,
      color: '#CD853F',
      type: 'livestock',
      detail: '15 breeding sows producing R220-375K/year',
    },
    {
      id: 'chickens',
      name: 'Chickens',
      ...
      color: '#DEB887',
      type: 'livestock',
      detail: 'Free-range layers producing R296-348K eggs/year',
    },
    {
      id: 'manure2',
      name: 'Mixed Manure',
      ...
      color: '#6B5D4F',
      type: 'byproduct',
      detail: 'Diverse nutrient profile from 4 species',
    },
    {
      id: 'soil',
      name: 'Soil Health',
      ...
      color: '#4C3F2F',
      type: 'outcome',
      detail: 'Increases 2-3% OM, improves water retention 30%',
    },
  ];
  ...
  return (
    ...
    >
      ...
      <desc>
        Flow chart showing how Sekelbos feeds goats, goat manure fertilizes crops, crops and lucerne create feed mix,
        which sustains cattle/pigs/chickens, whose manure improves soil health in a closed-loop system
      </desc>
      ...
      <defs>
        ...
        <marker id="arrow-solid" markerWidth="10" markerHeight="10" refX="9" refY="5" orient="auto">
      ...
      <text x="450" y="52" textAnchor="middle" fontSize="14" fill="#4C3F2F" opacity={animationProgress}>
      ...
      {flows.map((flow, index) => {
        ...
        return (
          <g key={index} opacity={animationProgress}>
            ...
            <rect x={midX - 30} y={midY - 12} width="60" height="20" fill="white" opacity="0.95" rx="4" />
            <text x={midX} y={midY + 2} textAnchor="middle" fontSize="10" fill="#4C3F2F" fontWeight="600">
              {flow.label}
            </text>
          </g>
        );
      ...
      {nodes.map((node, index) => {
        const radius = node.type === 'livestock' ? 55 : node.type === 'outcome' ? 60 : 50;
        ...
        return (
          ...
          >
            {/* Shadow */}
            <ellipse cx={node.x + 3} cy={node.y + 43} rx={radius * scale + 2} ry="9" fill="#000000" opacity="0.12" />
      ...
      <g transform="translate(50, 660)" opacity={animationProgress}>
        <rect width="800" height="52" fill="#F5F5F0" stroke="#4C3F2F" strokeWidth="2" rx="8" />
      ...
      <g transform="translate(720, 100)" opacity={animationProgress}>
        ...
        <text x="48" y="44" fontSize="10" fill="#4C3F2F">
          Growth cycle
        </text>

        <circle cx="8" cy="60" r="7" fill="#5DAA68" opacity="0.4" />
        <text x="18" y="64" fontSize="9" fill="#666">
          Animated flow
        </text>
      </g>
      ...
      {/* Interaction hint */}
      {interactive && (
        <text x="450" y="715" textAnchor="middle" fontSize="9" fill="#9CA3AF" opacity={animationProgress * 0.7}>
