...
export const LandUseMap: React.FC<LandUseMapProps> = ({
  ...
  const calculateZonesForYear = (year: number) => {
    ...
    return [
      ...
      },
      {
        ...
        description:
          'Solar-powered irrigation hub with high-value vegetables, lucerne for livestock feed, and homestead area',
      },
      {
        id: 'northern-slope',
        name: 'Northern Slope',
  ...
  return (
    ...
    >
      ...
      <desc>
        Interactive map showing the allocation of 600 hectares into 5 zones: Western Ridge (40-50%), Central Plateau
        (25%), Eastern Corridor (20%), Southern Foot (10%), and Northern Slope (5%)
      </desc>
      ...
      {zones.map((zone, index) => {
        ...
        return (
          <g key={zone.id}>
            ...
            <text
              x={
                zone.id === 'western-ridge'
                  ? 100
                  : zone.id === 'central-plateau'
                    ? 280
                    : zone.id === 'eastern-corridor'
                      ? 455
                      : zone.id === 'southern-foot'
                        ? 280
                        : 280
              }
              y={
      ...
      <g transform="translate(560, 450)" opacity={animationProgress}>
        ...
        <text x="0" y="-28" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#4C3F2F">
          N
        </text>
      </g>
      ...
      {interactive && clickable && (
        <text x="300" y="495" textAnchor="middle" fontSize="9" fill="#9CA3AF" opacity={animationProgress * 0.7}>
