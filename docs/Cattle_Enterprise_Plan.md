...
**Current Bull:** Santa Gertrudis (5/8 Shorthorn × 3/8 Brahman)  
**Cow Genetics:** Composite (Nguni/Brahman/Santa Gertrudis/Bonsmara)  
**Target Herd:** 138 head by Year 5 (90 cows, 5 bulls, 43 calves)  
**System:** Rotational mob grazing on cleared sekelbos areas  
**5-Year Revenue:** R2.1M-3.8M (weaners + cull cows + bulls)
...
- Limited weaner marketing strategy

### Optimization Strategy

**Three-Pillar Approach:**

1. **Maintain Composite Genetics**
   - Keep hybrid vigor (15-25% performance advantage)
   - Preserve drought/heat adaptation
   - Continue Santa Gertrudis bull program (carcass quality)

2. **Implement Rotational Grazing**
   - 40 paddocks × 15ha each
   - High-density mob grazing (3-5 days per paddock)
   - 40-60 day rest periods
   - Follow cleared sekelbos areas first

3. **Maximize Weaner Value**
   - Santa Gertrudis genetics = premium weaners
   - Target 200-250kg @ 7-9 months
   - Market timing (autumn sales, high demand)
   - Genetic selection (moderate frame, efficiency)
...
## SECTION 1: COMPOSITE HERD GENETICS ANALYSIS

### 1.1 Breed Contributions & Traits
...
- Easy calving (small calves 25-30kg, low dystocia)
- Tick resistant (genetic resistance to tick-borne diseases)
- Heat tolerant (short coat, efficient heat dissipation)
...
- Disease resistant (tick, fly, internal parasite resistance)
- Hardy (survive harsh conditions, recover from weight loss)
...
- Medium to large frame (cows 550-750kg, bulls 900-1,200kg)
- Heat tolerant (Brahman genetics)
...
- Medium frame (cows 450-600kg, bulls 850-1,100kg)
- High fertility (selected for reproductive efficiency)
- Good temperament (docile, easy handling)
...
- **Balance:** Moderate frame (not too large for low rainfall)

### 1.2 Composite Herd Advantages

#### Hybrid Vigor (Heterosis):

**Definition:** Crossbred performance exceeds average of parent breeds  
...
- Longevity: +15-20% productive years
...
- **Composite (with hybrid vigor): 83% calving rate, 220kg weaner weight**
...
### 1.3 Genetic Management Strategy

#### Maintain Composite Balance:

- **Do NOT "purify" to single breed** (lose hybrid vigor)
- Keep genetic diversity (Nguni/Brahman/SG/Bonsmara mix)
- Avoid European breeds (Hereford, Angus too high-input for 315mm)
...
- Purchase: Every 3-4 years (prevent inbreeding, introduce new genetics)
...
- **Fertility:** Calve by 30-36 months, regular calving thereafter
...
- **Health:** Chronic issues (mastitis, lameness, poor body condition)
- **Production:** Poor calf performance (small, weak calves)
- **Target:** Cull 8-12% annually (maintain herd quality)

---

## SECTION 2: ROTATIONAL GRAZING SYSTEM

### 2.1 Paddock Design

#### Current System (Assumed):

- Continuous grazing or simple 2-4 paddock rotation
- Overgrazing near water points
- Undergrazing in distant areas
- Selective grazing (cattle eat best grass, leave weeds)
- **Result:** Degraded pastures, low carrying capacity
...
- Fencing: Electric fencing (polywire, step-in posts)
...
- **Grass recovery:** Long rest allows full regrowth
- **Weed control:** Cattle trample seedlings (including sekelbos)
...
- Stocking: Cows only (calves weaned, lower demand)
- Supplement: Lucerne or hay (if body condition declines)
...
- Emergency feed: Sekelbos pods (cattle eat pods, nutritious)
- **Composite genetics critical:** Herd survives better than European breeds

### 2.3 Integration with Sekelbos Clearance
...
- **Benefit:** Carrying capacity increases 60-70% (vs Year 0)
...
- **Mechanism:** Trampling (seedlings crushed, organic matter incorporated)
...
- **Result:** Cleared areas stay cleared (no regrowth)
...
- Length: 40 paddocks × 400m average perimeter = 16,000m
- Cost: R50-80 per meter installed = R800K-1.28M
...
- Labor: 1-2 hours daily (move fence)
- **Recommendation:** Start temporary (Year 1-2), transition to permanent (Year 3+)
...
- Options:
  ...
  - Piped water (permanent lines to each paddock)
...
- Float valves: Automatic filling
- Cost: R150K-300K (depends on distance, terrain)
- **Benefit:** Eliminates daily water hauling labor
...
- Handling: R30K-60K (upgrades)
- **Total (Permanent System): R980K-1.64M** (phased over 3 years)

**Recommendation:** Start with temporary fencing/water (Year 1-2), transition to permanent (Year 3+) as clearance progresses and cash flow improves.
...
**Related Documents:** Zeerust_Partnership_Proposal_v4.0.md  
**Status:** Complete - Sections 1 & 2

---

**END OF CATTLE ENTERPRISE PLAN - SECTIONS 1 & 2**

## SECTION 3: BREEDING & HERD MANAGEMENT
...
- **Timing:** December-February (summer)
- **Rationale:** Calving in September-November (spring grass, optimal nutrition)

#### Bull Management:

- **Ratio:** 1 bull per 20-25 cows
- **Current:** 3 bulls for 50 cows (adequate)
- **Year 5:** 5 bulls for 90 cows (add 2 bulls)
- **Rotation:** Rotate bulls between cow groups (prevent inbreeding)
- **Rest:** Bulls rested outside breeding season (separate paddock)

#### Pregnancy Testing:

- **Timing:** 60-90 days post-breeding (March-May)
- **Method:** Rectal palpation or ultrasound (veterinarian)
- **Purpose:** Identify open cows (cull or re-breed)
- **Cost:** R50-100 per cow
- **Benefit:** Cull non-pregnant cows early (save feed costs)

### 3.2 Calving Management

#### Calving Season:

- **Peak:** September-November (spring)
- **Duration:** 90-120 days (concentrated calving)
- **Benefit:** Uniform calf ages (easier management, marketing)

#### Calving Paddock:

- **Location:** Near homestead (easy observation)
- **Size:** 20-30ha (sufficient for 50-90 cows)
- **Grass:** Best quality (cows need high nutrition)
- **Water:** Close access (cows drink more post-calving)
- **Shelter:** Trees or windbreak (calf protection)

#### Calving Checks:

- **Frequency:** 2-3 times daily (morning, midday, evening)
- **Purpose:** Assist difficult births, check calf health
- **Intervention:** Minimal (composite genetics = easy calving)
- **Dystocia rate:** Target <5% (vs 10-15% large breeds)

#### Calf Processing (Within 24 Hours):

- **Colostrum check:** Ensure calf nurses (critical for immunity)
- **Navel dip:** Iodine solution (prevent infection)
- **Ear tag:** Identification (calf number, dam number, birth date)
- **Record:** Birth weight, sex, dam, sire (breeding records)

### 3.3 Weaning Management

#### Weaning Age:

- **Target:** 7-9 months (April-June, autumn)
- **Weight:** 200-250kg (Santa Gertrudis-cross weaners)
- **Timing:** Autumn weaner sales (high demand, good prices)

#### Weaning Method:

- **Abrupt separation:** Calves separated from cows (different paddocks)
- **Distance:** 500m+ apart (reduce calling stress)
- **Duration:** 7-14 days (calves adjust)
- **Feeding:** Calves on best grass paddock (maintain weight)

#### Weaner Management (Post-Weaning):

- **Paddock:** High-quality grass (maintain growth)
- **Supplement:** Lick blocks (minerals, protein)
- **Health:** Vaccinations, deworming (pre-sale)
- **Marketing:** Sell within 30-60 days (avoid weight loss)

### 3.4 Herd Health Management
...
**Total Annual Vaccination Cost:** R3,000-6,000 (Year 5 herd)
...
- **Cost:** R15-30 per animal per treatment
...
- **Cost:** R10-20 per animal per treatment
- **Composite advantage:** Nguni/Brahman genetics = natural tick resistance

**Total Annual Parasite Control:** R2,000-5,000 (Year 5 herd)
...
- **Cost:** R8-12 per kg, R150-250 per cow per year
...
- **Benefit:** Improved fertility, calf health (especially in deficient soils)
...
## SECTION 4: MARKETING & REVENUE

### 4.1 Weaner Marketing Strategy

#### Target Market:

- **Primary:** Feedlots (80-90% of weaners)
- **Secondary:** Backgrounding operations, other farmers
- **Geographic:** North West, Gauteng, Free State

#### Weaner Specifications:

- **Weight:** 200-250kg (7-9 months)
- **Sex:** Steers and heifers (separate lots)
- **Health:** Vaccinated, dewormed, no visible defects
- **Genetics:** Santa Gertrudis-cross (premium)

#### Pricing (Autumn Sales - April-June):

- **Steers:** R40-50 per kg live weight
- **Heifers:** R38-48 per kg live weight
- **Premium:** +R2-5/kg for SG-cross genetics
- **Example:** 220kg steer × R45/kg = R9,900
...
- **Costs:** Commission 3-5%, transport R500-1,000 per load
...
- **Costs:** Grazing, supplement, opportunity cost
- **Recommendation:** Only if grazing capacity allows (post-clearance)
...
- **Annual culling rate:** 8-12% of breeding herd
- **Reasons:** Age (>12 years), poor fertility, health issues, temperament
- **Weight:** 350-450kg (depending on body condition)
- **Price:** R22-28/kg live weight (cull cow market)
- **Revenue per cow:** R7,700-12,600
...
- **Frequency:** Every 4-5 years (replace aged bulls)
- **Weight:** 800-1,000kg
- **Price:** R28-35/kg (cull bull market)
- **Revenue per bull:** R22,400-35,000
- **5-Year Total:** 1-2 bulls = R22,400-70,000
...
### 5.3 Capital Investment Summary
...
- **Total: R57,000-109,000**
- **Advantage:** Low upfront cost, test system before permanent investment
...
- Handling facility upgrades: R30,000-60,000
- **Total: R980,000-1,640,000** (phased over 3 years)
- **Advantage:** Reduced labor, long-term efficiency
- **Disadvantage:** High upfront cost, requires financing

**Recommendation:** Start with Option A (Year 1-2), transition to Option B (Year 3+) as clearance progresses and revenue grows
...
- Infrastructure investment: R980,000-1,640,000
- 5-Year net profit: R402,540-607,780 (after infrastructure)
- ROI: 41-37% over 5 years
- Payback period: 6-8 years
- **Recommendation:** Permanent system justified if long-term operation (10+ years)
...
- Emergency feed (sekelbos pods nutritious)
- Water security (multiple boreholes)

**Financial impact:** R50K-150K (supplement costs, lower weaner prices)
...
- Early detection (daily checks)

**Financial impact:** R20K-100K (depending on severity)

#### Risk 3: Predators (Jackal, Caracal)
...
- Composite genetics (strong maternal instincts, calf protection)

**Financial impact:** R20K-60K annually (lost calves)

### 6.2 Market Risks

#### Risk 1: Weaner Price Volatility
...
- Retain ownership (background if prices low)

**Financial impact:** ±20-30% revenue variation

#### Risk 2: Feedlot Demand Decline
...
**Financial impact:** R50K-150K (delayed sales, lower prices)
...
**Financial impact:** R10K-30K (repairs, lost grazing days)
...
**Financial impact:** R5K-20K (emergency labor, lost productivity)
...
- **Calving rate:** Target 75-85% (Year 1-5 progression)
- **Calf survival:** Target >95% (birth to weaning)
- **Calving interval:** Target 13-15 months
- **Dystocia rate:** Target <5%

#### Growth Performance:

- **Weaning weight:** Target 200-250kg @ 7-9 months
- **Average daily gain (birth to weaning):** Target 0.8-1.0 kg/day
- **Weaner uniformity:** Target 80%+ within 20kg range

#### Financial Performance:

- **Revenue per cow:** Target R4,000-6,000 annually
- **Operating cost per cow:** Target R1,100-2,500 annually
- **Net profit per cow:** Target R2,500-3,500 annually
- **Profit margin:** Target 60-75%

#### Grazing Performance:

- **Carrying capacity:** Target 1 LSU per 4-6ha (post-clearance)
- **Grass recovery:** Target 40-60 day rest periods
- **Paddock utilization:** Target 60-70% (even grazing)
- **Sekelbos regrowth:** Target <5% on cleared areas
...
The Cattle Enterprise is the anchor of the Zeerust regenerative agriculture system:

### Key Strengths:

- **Existing asset:** 72-head composite herd (R720K-1.08M value)
- **Proven genetics:** Santa Gertrudis bull + composite cows (optimal for 315mm)
- **Premium weaners:** SG-cross genetics command R8,000-12,000 per head
- **Low-input system:** Composite genetics = 30-40% lower costs vs European breeds
- **Scalable:** Grow to 138 head by Year 5 (as clearance increases capacity)
- **Profitable:** R1.38M-1.74M revenue over 5 years, 60-75% profit margins

### Integration with Sekelbos Clearance:

- Cattle are Phase 5 of clearance (trampling, maintenance grazing)
- Rotational grazing prevents regrowth (grass competition)
- Carrying capacity increases 60-70% as clearance progresses
- Property value increases R2M-4M (cleared land)

### Investment Required:

- **Option A (Temporary):** R57K-109K
- **Option B (Permanent):** R980K-1.64M (phased over 3 years)

**This is not just cattle ranching—it's a strategic integration of proven genetics, regenerative grazing, and sekelbos clearance that transforms degraded land into a productive, profitable livestock enterprise.**
