...
import { Milk, TrendingUp, Package, DollarSign, Users, CheckCircle, Target, Dna, Leaf, Calendar, Award } from 'lucide-react';
  ...
  const dualPurposeStrategies: Strategy[] = [
    {
      ...
      description: '63 does browse sekelbos extensively, raise kids to market weight (15-20kg @ 4-5 months). Natural kidding in spring, 160% kidding rate, 86 kids sold annually @ R900-1,600 each. Revenue: R77K-138K per year.'
    },
    {
      icon: Milk,
      ...
      description: '27 does hand-milked daily, staggered breeding for year-round milk (840-1,620L monthly). Produce fresh chèvre cheese (150-200g per liter). Revenue: R114K-261K per year (milk + cheese + kids).'
    },
    {
      icon: Award,
      ...
      description: 'Same indigenous/Rooikop genetics for all does—shift between meat/dairy roles based on market demand. Best milkers selected for dairy, others for meat production. Adjust herd composition dynamically.'
    }
  ];
  ...
  const indigenousAdvantages: FeatureItem[] = [
    {
      ...
      description: 'Red Head Afrikaner: 300+ years evolution in 200-600mm rainfall zones, 35-45kg does, 140-180% kidding rate'
    },
    {
      icon: CheckCircle,
      iconColor: 'text-green-600 dark:text-green-400',
      title: 'Drought Tolerance',
      description: '2-4L water per day (vs 5-8L commercial), 80% browse diet (sekelbos), tail fat reserves, thrive on low-quality forage'
    },
    {
      icon: CheckCircle,
      iconColor: 'text-green-600 dark:text-green-400',
      title: 'Dual-Purpose Genetics',
      description: '1-2L milk per day (120-180 day lactation), 4-5% butterfat (ideal for cheese), twins/triplets common'
    },
    {
      icon: CheckCircle,
      iconColor: 'text-green-600 dark:text-green-400',
  ...
  const sekelbosIntegration: FeatureItem[] = [
    {
      ...
      description: 'High-density browsing (100-150 goats per 15ha, 7-14 days). Strip 60-80% of sekelbos leaves, damage bark, destroy seedlings.'
    },
    {
      icon: Target,
      iconColor: 'text-orange-600 dark:text-orange-400',
      title: 'Revenue-Generating Clearance',
      description: 'Goats gain weight while browsing (0.08-0.12kg/day). Earn R40K-80K annually as living lawnmowers + meat/milk sales.'
    },
    {
      icon: TrendingUp,
      iconColor: 'text-orange-600 dark:text-orange-400',
      title: 'Selective Browsing',
      description: '80/20 browse-to-grass ratio: goats target sekelbos over pasture, access steep slopes/dense thickets cattle cannot reach.'
    },
    {
      icon: Award,
      iconColor: 'text-orange-600 dark:text-orange-400',
      title: 'Nutrient Cycling',
      description: 'Goat manure fertilizes soil (high nitrogen). Reduce fuel load before mechanical cutting. 60-90 day rest periods.'
    }
  ];
  ...
  const chevreProduction: FeatureItem[] = [
    {
      ...
      description: 'Creamy, tangy spreadable cheese. 1L milk = 150-200g cheese. Sell @ R180-280/kg (9-14x value vs raw milk @ R20/L).'
    },
    {
      icon: Package,
      iconColor: 'text-blue-600 dark:text-blue-400',
      title: 'Production Capacity',
      description: 'Year 5: 810-1,620L milk monthly from 27 dairy does. Yields 122-324kg chèvre monthly. Revenue: R22K-91K/month.'
    },
    {
      icon: DollarSign,
      iconColor: 'text-blue-600 dark:text-blue-400',
      title: 'Premium Positioning',
      description: 'Target restaurants, specialty stores, farm shop. Add herbs (chives, dill), roll in ash/nuts. Lactose-intolerant market.'
    },
    {
      icon: Calendar,
      iconColor: 'text-blue-600 dark:text-blue-400',
      title: 'Year-Round Production',
      description: 'Staggered breeding (3 groups × 9 does kid every 4 months). 18 does in milk at any time. Daily cash flow.'
    }
  ];
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <main className={styles.mainContent}>
        ...
        <StrategyCard
          title="Dual-Purpose Management Strategy"
          strategies={dualPurposeStrategies}
          columns={3}
        />
          ...
          <div className={styles.geneticsContainer}>
            <div className={styles.geneticsIntro}>
              ...
              <p className={styles.geneticsDescription}>
                Rooikop (Red Head Afrikaner) goats evolved over 300+ years in South Africa's harshest 
                conditions (200-600mm rainfall). Indigenous genetics deliver superior drought tolerance, 
                browse preference for sekelbos, dual-purpose milk/meat production, and 40-60% lower 
                operating costs than commercial breeds.
              </p>
            </div>
            <FeatureCard 
              title="Indigenous vs Commercial Comparison" 
              features={indigenousAdvantages}
            />
          ...
          <div className={styles.grazingContainer}>
            <div className={styles.grazingIntro}>
              ...
              <p className={styles.grazingDescription}>
                Goats are Phase 2 of the sekelbos clearance system—browsing before mechanical cutting. 
                High-density browsing (100-150 goats per 15ha for 7-14 days) strips leaves, damages bark, 
                and destroys seedlings while generating revenue through weight gain and meat/milk production.
              </p>
            </div>
            <FeatureCard 
              title="Goat Browsing Strategy" 
              ...
              <div className={styles.phaseGrid}>
                <div className={styles.phaseCard}>
                  ...
                  <p className={styles.phaseDescription}>
                    3-4 paddocks × 15ha. Foundation herd (6 current + 29 purchased/born). 
                ...
                <div className={styles.phaseCard}>
                  ...
                  <p className={styles.phaseDescription}>
                    6-7 paddocks. 25 kids retained for herd growth. 
                    Revenue: R120K-231K.
                  </p>
                </div>
                <div className={styles.phaseCard}>
                  ...
                  <p className={styles.phaseDescription}>
                    10 paddocks. Dairy operation scales to 21 does in milk. 
                    Revenue: R204K-357K.
                  </p>
                </div>
                <div className={styles.phaseCard}>
                  ...
                  <p className={styles.phaseDescription}>
                    20 paddocks (full system). Herd stabilized at 115 goats. 
                    Revenue: R267K-500K.
                  </p>
                </div>
              </div>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.geneticsContainer}>
            <div className={styles.geneticsIntro}>
              ...
              <p className={styles.geneticsDescription}>
                Transform raw goat milk into premium chèvre cheese: creamy, tangy, spreadable soft cheese 
                commanding R180-280/kg (vs R20/L raw milk). Add herbs (chives, dill), roll in ash/nuts for 
                visual appeal. Target lactose-intolerant consumers, restaurants, specialty stores.
              </p>
            </div>
            <div className={styles.twoColumnGrid}>
              <FeatureCard 
                title="Chèvre Production System" 
                features={chevreProduction}
              />
              ...
              <table className={styles.financialTable}>
                ...
                <tbody>
                  ...
                  <tr className={styles.totalRow}>
                    ...
                    <td><strong>-</strong></td>
                    <td><strong>R498K-841K</strong></td>
                    <td><strong>R502K</strong></td>
                    <td><strong>R93.8K</strong></td>
                    <td className={styles.grandTotal}><strong>R1.05M-1.47M</strong></td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div className={styles.financialNotes}>
              <div className={styles.noteItem}>
                ...
                <p className={styles.noteText}>
                  <strong>Operating Costs (Year 5):</strong> R80K-160K (R696-1,391 per goat) - 40-60% lower than commercial breeds
                </p>
              </div>
              <div className={styles.noteItem}>
              ...
              <div className={styles.noteItem}>
                ...
                <p className={styles.noteText}>
                  <strong>Dairy Impact:</strong> +91% revenue increase vs meat-only operation (chèvre at R180-280/kg vs R20/L raw milk = 9-14x value)
                </p>
              </div>
            </div>
          </div>
