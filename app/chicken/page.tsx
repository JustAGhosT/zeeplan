  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <main className={styles.mainContent}>
        ...
        <StrategyCard title="Multi-Breed Flock Strategy" strategies={multiBreedStrategy} columns={3} />
          ...
          <div className={styles.geneticsContainer}>
            <div className={styles.geneticsIntro}>
              ...
              <p className={styles.geneticsDescription}>
                Strategic multi-breed flock combines Koekoek (indigenous South African, exceptional foraging), Rhode
                Island Red (American heritage, premium brown eggs), and Australorp (Australian, world-record
          ...
          <div className={styles.grazingContainer}>
            <div className={styles.grazingIntro}>
              ...
              <p className={styles.grazingDescription}>
                Chickens are Phase 4 of the sekelbos clearance system—scratching after mechanical cutting. High-density
                scratching (200-300 chickens per 10ha for 2-4 weeks) reduces seed bank by 40-60% through seed
                consumption, exposure to predation, and desiccation while generating egg revenue and providing
                high-nitrogen fertilization.
              </p>
            </div>
            <FeatureCard title="Chicken Scratching Strategy" features={sekelbosIntegration} />
        ...
        <section className={styles.section}>
          ...
          <div className={styles.geneticsContainer}>
            <div className={styles.geneticsIntro}>
              ...
              <p className={styles.geneticsDescription}>
                Year 5 target: 108,000 eggs annually (9,000 per month, 295 per day). Collection 2-3 times daily, grading
                by size (Small, Medium, Large, Extra Large), refrigerated storage (10-15°C, 80% humidity, &lt;21 days).
                Premium pricing for heritage breed (Koekoek +R5-10/dozen) and brown eggs (RIR).
              </p>
            </div>
            <div className={styles.twoColumnGrid}>
              <FeatureCard title="Egg Production System" features={eggProduction} />
              ...
              <table className={styles.financialTable}>
                ...
                <tbody>
                  ...
                  <tr className={styles.totalRow}>
                    ...
                    <td>
                      <strong>R670.5K-1.03M</strong>
                    </td>
                    <td>
                      <strong>R149.9K-237K</strong>
                    </td>
                    <td>
                      <strong>R65K-92K</strong>
                    </td>
                    <td className={styles.grandTotal}>
                      <strong>R851.4K-1.34M</strong>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className={styles.financialNotes}>
              <div className={styles.noteItem}>
                ...
                <p className={styles.noteText}>
                  <strong>Operating Costs (Year 5):</strong> R213K-312.5K (R426-625 per bird) - 40-50% lower than
              ...
              <div className={styles.noteItem}>
                ...
                <p className={styles.noteText}>
                  <strong>Quick Returns:</strong> Eggs start 18-20 weeks, daily cash flow, lowest entry cost (R78K-127K
                  infrastructure)
                </p>
              </div>
            </div>
        ...
        {/* Dual Stream Section */}
        <StrategyCard title="Dual Revenue Approach" strategies={productionStreams} columns={2} />

        {/* Timeline Section */}
        <TimelineSection title="Development Timeline" items={timelineItems} />

        {/* Market Strategy Section */}
        <StrategyCard title="Market Strategy" strategies={marketStrategies} columns={4} />

        {/* Key Benefits Section */}
        <BenefitsSection title="Why Chicken & Egg Production?" benefits={benefits} />
      </main>
