...
export default function CattlePage() {
  ...
  const hybridVigorBenefits: Benefit[] = [
    ...
    },
    {
      ...
      description:
        '400-500kg mature cows: perfect balance for 315mm rainfall, adequate weaner weights without excessive feed costs',
    },
  ];
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.section}>
          <div className={styles.twoColumnGrid}>
            <FeatureCard title="Current Operations" features={currentFeatures} />
            <FeatureCard title="Year 5 Target" features={targetFeatures} variant="target" />
          </div>
        </section>

        {/* Strategy & Management Section */}
        <StrategyCard title="Three-Pillar Management Strategy" strategies={strategies} columns={3} />
          ...
          <div className={styles.geneticsContainer}>
            <div className={styles.geneticsIntro}>
              ...
              <p className={styles.geneticsDescription}>
                Our composite herd combines four complementary breeds to maximize performance in Zeerust's 315mm
                rainfall environment. This strategic genetic mix delivers 15-25% hybrid vigor advantage while preserving
                drought adaptation, heat tolerance, and disease resistance.
              </p>
            </div>
            <div className={styles.twoColumnGrid}>
            ...
            <div className={styles.geneticsHighlight}>
              ...
              <p className={styles.highlightText}>
                Current Santa Gertrudis bull (5/8 Shorthorn × 3/8 Brahman) ensures continued improvement in muscling,
                marbling, and carcass quality. SG-cross weaners command 20-40% premium (R8,000-12,000 vs R6,000-9,000
                indigenous) due to excellent feedlot finishing and meat quality. Plan: Add additional SG bulls in Years
                2-5 to strengthen influence and maximize weaner premiums.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className={styles.grazingContainer}>
            <div className={styles.grazingIntro}>
              ...
              <p className={styles.grazingDescription}>
                Transition from continuous grazing to high-density mob grazing system across 40 paddocks. This
                regenerative approach improves pasture health, increases carrying capacity by 60-70%, and integrates
                with sekelbos clearance program for optimal land recovery.
              </p>
            </div>
            <FeatureCard title="System Design & Infrastructure" features={grazingFeatures} />
              ...
              <div className={styles.phaseGrid}>
                <div className={styles.phaseCard}>
                  ...
                  <p className={styles.phaseDescription}>
                    3-4 paddocks (12-15ha each). Graze cleared areas first for best grass recovery. Start with temporary
                    electric fencing (R15K-25K) and portable troughs (R12K-24K).
                  </p>
                </div>
                <div className={styles.phaseCard}>
                  <div className={styles.phaseHeader}>
                  ...
                  <p className={styles.phaseDescription}>
                    10 paddocks (15ha each). Systematic rotation on cleared paddocks. Carrying capacity increases
                    20-30%. Begin transition to permanent infrastructure.
                  </p>
                </div>
                <div className={styles.phaseCard}>
                  <div className={styles.phaseHeader}>
                  ...
                  <p className={styles.phaseDescription}>
                    18 paddocks (15ha each). Full rotational system on cleared areas. Carrying capacity increases
                    40-50%. Install permanent fencing and piped water system.
                  </p>
                </div>
                <div className={styles.phaseCard}>
                  <div className={styles.phaseHeader}>
                  ...
                  <p className={styles.phaseDescription}>
                    Full 40-paddock system across entire property. Systematic rotation prevents sekelbos regrowth.
                    Carrying capacity increases 60-70% vs Year 0. Maintenance grazing only.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className={styles.seasonGrid}>
                <div className={styles.seasonCard}>
                  ...
                  <p className={styles.seasonText}>
                    Peak growth (300-600kg DM/ha/month). Short grazing periods (3-5 days), 40-60 day rest. Full herd +
                    calves.
                  </p>
                </div>
                <div className={styles.seasonCard}>
                  ...
                  <p className={styles.seasonText}>
                    Declining/dormant growth (50-400kg DM/ha/month). Longer grazing (5-7 days), 60-80 day rest.
                ...
                <div className={styles.seasonCard}>
                  ...
                  <p className={styles.seasonText}>
                    Reduce stocking, extend rest (70-90 days), supplement with lucerne/lick blocks. Prioritize
                    pregnant/young cows.
                  </p>
                </div>
                <div className={styles.seasonCard}>
                  ...
                  <p className={styles.seasonText}>
                    Aggressive destocking (20-30%), focus best paddocks only, heavy supplementation. Composite genetics
              ...
              <table className={styles.financialTable}>
                ...
                <tbody>
                  ...
                  <tr className={styles.totalRow}>
                    ...
                    <td>
                      <strong>R1.25M-1.82M</strong>
                    </td>
                    <td>
                      <strong>R158K-237K</strong>
                    </td>
                    <td className={styles.grandTotal}>
                      <strong>R1.41M-2.06M</strong>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className={styles.financialNotes}>
              <div className={styles.noteItem}>
                ...
                <p className={styles.noteText}>
                  <strong>Additional Value:</strong> Increased grazing capacity generates R200K-400K annually
                  post-clearance
                </p>
              </div>
              <div className={styles.noteItem}>
        ...
        {/* Timeline Section */}
        <TimelineSection title="5-Year Development Timeline" items={timelineItems} />

        {/* Key Benefits Section */}
        <BenefitsSection title="Why Cattle as the Foundation?" benefits={benefits} />
      </main>
