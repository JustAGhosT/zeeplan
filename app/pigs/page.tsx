  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <main className={styles.mainContent}>
        ...
        <StrategyCard title="Rare Genetics & Dual-Line Strategy" strategies={rareGeneticsStrategy} columns={3} />
          ...
          <div className={styles.geneticsContainer}>
            <div className={styles.geneticsIntro}>
              ...
              <p className={styles.geneticsDescription}>
                Strategic dual-line system combines rare Mukota indigenous genetics (critically endangered, &lt;500
                globally) crossed with Duroc and Large White for hybrid vigor, plus separate miniature line for
                pet/educational market. Mukota provides extreme heat tolerance, foraging ability (40-60% diet from
                pasture), and disease resistance adapted to 315mm rainfall zones.
              </p>
            </div>
            <FeatureCard title="Breed Performance Comparison" features={breedComparison} />
          ...
          <div className={styles.grazingContainer}>
            <div className={styles.grazingIntro}>
              ...
              <p className={styles.grazingDescription}>
                Pigs are Phase 3 of the sekelbos clearance system—rooting after goat browsing and before chicken
                scratching. High-intensity rooting (10-15 pigs per 5ha for 4-8 weeks) destroys root systems at 20-30cm
                depth, achieving 80-90% root destruction vs 40-60% from mechanical cutting alone while generating
                revenue and providing soil aeration and manure fertilization.
              </p>
            </div>
            <FeatureCard title="Pig Rooting Strategy" features={sekelbosIntegration} />
              ...
              <div className={styles.phaseGrid}>
                <div className={styles.phaseCard}>
                  ...
                  <p className={styles.phaseDescription}>
                    3-4 mobile paddocks (4 sows, 1 boar, 16 growers). Foundation herd, establish systems. Revenue:
                    R90K-180K (meat + breeding).
                  </p>
                </div>
                <div className={styles.phaseCard}>
                  <div className={styles.phaseHeader}>
                ...
                <div className={styles.phaseCard}>
                  ...
                  <p className={styles.phaseDescription}>
                    Herd stabilized (10 sows, 2 boars, 30 growers). Systematic rotation, value-added mature. Revenue:
                    R276K-535K.
                  </p>
                </div>
              </div>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.geneticsContainer}>
            <div className={styles.geneticsIntro}>
              ...
              <p className={styles.geneticsDescription}>
                Diversified revenue model: Live sales to abattoirs (70%, R157.5K), direct whole/half pig sales (20%,
                R48K), premium Mukota heritage pork (10%, R32.5K), breeding stock sales (Mukota genetics R36K-70K
                annually), and value-added products (bacon, ham, sausages R50K-100K from Year 3).
              </p>
            </div>
            <div className={styles.twoColumnGrid}>
              <FeatureCard title="Revenue Streams (Year 5)" features={marketingRevenue} />
              ...
              <table className={styles.financialTable}>
                ...
                <tbody>
                  ...
                  <tr className={styles.totalRow}>
                    ...
                    <td>
                      <strong>R820K-1.44M</strong>
                    </td>
                    <td>
                      <strong>R130K-278K</strong>
                    </td>
                    <td>
                      <strong>R115K-265K</strong>
                    </td>
                    <td className={styles.grandTotal}>
                      <strong>R1.07M-1.98M</strong>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className={styles.financialNotes}>
              <div className={styles.noteItem}>
                ...
                <p className={styles.noteText}>
                  <strong>Operating Costs (Year 5):</strong> R156K-250K (R3,724-5,948 per pig) - 30-40% lower than
                  commercial due to Mukota foraging
                </p>
              </div>
              <div className={styles.noteItem}>
              ...
              <div className={styles.noteItem}>
                ...
                <p className={styles.noteText}>
                  <strong>Rare Genetics Premium:</strong> Mukota breeding stock R6K-9.1K/pig vs R4K-6K commercial,
        ...
        <section className={styles.section}>
          <div className={styles.twoColumnGrid}>
            <FeatureCard title="Production System" features={productionFeatures} />
            <div className={styles.targetCard}>
              <h2 className={styles.cardTitle}>Feed Efficiency</h2>
              <p className={styles.featureDescription}>
                Pigs are exceptional converters of feed to protein, making them one of the most efficient livestock
                options:
              </p>
              <div className={styles.featureList}>
                ...
                <div className="bg-white/50 dark:bg-gray-900/30 rounded-lg p-4">
                  ...
                  <p className={styles.progressBarDescription}>Rapid growth enables 2 production cycles per year</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <StrategyCard title="Infrastructure & Management" strategies={strategies} columns={3} />

        {/* Growth Timeline Section */}
        <TimelineSection title="Development Timeline" items={timelineItems} />
          ...
          <div className={styles.twoColumnGrid}>
            <div className={styles.featureList}>
              ...
              <div className={styles.card}>
                ...
                <p className={styles.strategyDescription}>
                  Supply local butcheries, supermarkets, and specialty food stores with fresh and processed pork
                  products.
                </p>
            ...
            <div className={styles.featureList}>
              <div className={styles.card}>
                ...
                <p className={styles.strategyDescription}>
                  Supply high-quality pork cuts to restaurants emphasizing locally-sourced ingredients. Build
        ...
        <BenefitsSection title="Why Pig Farming?" benefits={benefits} />
      </main>
